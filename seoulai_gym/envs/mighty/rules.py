...
class Rules(object):
    ...
    def get_valid_cards(
        ...
        # - 조커 사용, 효력, 조커콜
        if uid != game.start_player and game.jokercall == True:
        ...
        if game.start_player == uid:
            ...
            #turn_suit = board.FACE_CARDS[game.start_player][0]
    ...
    def get_point(
        ...
        # TODO get_point
        point_cards = ['s-1','s-k','s-q','s-j','s-0','d-1','d-k','d-q','d-j','d-0','c-1','c-k','c-q','c-j','c-0','h-1','h-k','h-q','h-j','h-0']
        point_card = []
